...
const ProfileDropdown = () => {
  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      ...
      <div
        className={`absolute right-0 mt-3 w-64 origin-top transform overflow-hidden rounded-xl border border-gray-100 bg-white shadow-xl transition-all duration-200 z-50 ${
          open
