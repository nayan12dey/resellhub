...
const Navbar = () => {
  ...
  // Ekhane ekhon true/false kore check korte পারো (Bhabishyote auth state use korbe)
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-4">
              {isLoggedIn ? (
                ...
                <>
                  <Link
                    href="/login"
                    className="rounded-lg px-4 py-2 text-sm font-medium text-gray-700 border border-gray-200 transition-colors hover:bg-gray-50"
                  >
                    Login
                  </Link>
                  <Link
            ...
            <button
              ...
              className="md:hidden text-3xl text-gray-700 transition-colors hover:text-blue-600 focus:outline-none"
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white shadow-md animate-in fade-in slide-in-from-top-5 duration-200">
